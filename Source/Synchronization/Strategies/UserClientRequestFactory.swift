...
public final class UserClientRequestFactory {
    ...
    public func registerClientRequest(_ client: UserClient, credentials: ZMEmailCredentials?, cookieLabel: String) throws -> ZMUpstreamRequest {
        ...
        let request = ZMTransportRequest(path: "/clients", method: ZMTransportRequestMethod.methodPOST, payload: payload as ZMTransportData, apiVersion: APIVersion.v0.rawValue)
    ...
    public func updateClientPreKeysRequest(_ client: UserClient) throws -> ZMUpstreamRequest {
        if let remoteIdentifier = client.remoteIdentifier {
            ...
            let request = ZMTransportRequest(path: "/clients/\(remoteIdentifier)", method: ZMTransportRequestMethod.methodPUT, payload: payload as ZMTransportData, apiVersion: APIVersion.v0.rawValue)
            request.add(storeMaxRangeID(client, maxRangeID: preKeysRangeMax))
    ...
    public func deleteClientRequest(_ client: UserClient, credentials: ZMEmailCredentials?) -> ZMUpstreamRequest {
        ...
        let request =  ZMTransportRequest(path: "/clients/\(client.remoteIdentifier!)", method: ZMTransportRequestMethod.methodDELETE, payload: payload as ZMTransportData, apiVersion: APIVersion.v0.rawValue)
    ...
    public func fetchClientsRequest() -> ZMTransportRequest! {
        return ZMTransportRequest(getFromPath: "/clients", apiVersion: APIVersion.v0.rawValue)
    }
