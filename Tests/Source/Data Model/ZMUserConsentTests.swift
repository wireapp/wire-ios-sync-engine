...
final class ZMUserConsentTests: DatabaseTest {
    ...
    func testThatItCanFetchState() {
        ...
        mockTransportSession.responseGeneratorBlock = { request in
            ...
            return ZMTransportResponse(payload: ["results": [["type": 2, "value": 1]]] as ZMTransportData, httpStatus: 200, transportSessionError: nil, apiVersion: .v0)
        }
    ...
    func testThatItFailsOnInvalidOperation_get() {
        ...
        mockTransportSession.responseGeneratorBlock = { request in
            ...
            return ZMTransportResponse(payload: ["label": "invalid-op"] as ZMTransportData, httpStatus: 403, transportSessionError: nil, apiVersion: .v0)
        }
    ...
    func testThatItCanSetTheState() {
        ...
        mockTransportSession.responseGeneratorBlock = { request in
            ...
            return ZMTransportResponse(payload: nil, httpStatus: 200, transportSessionError: nil, apiVersion: .v0)
        }
