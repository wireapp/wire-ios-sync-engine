...
class RegistrationStrategyTests: MessagingTest {
    ...
    func testThatItCallsParseUserInfoOnSuccess() {
        ...
        let response = ZMTransportResponse(payload: ["user": UUID.create().transportString()] as ZMTransportData, httpStatus: 200, transportSessionError: nil, headers: ["Set-Cookie": cookie], apiVersion: 0)
