...
extension UserImageAssetUpdateStrategyTests {
    ...
    func testThatItCreatesDeleteRequestIfThereAreAssetsToDelete() {
        // GIVEN
        let assetId = "12344"
        let deleteRequest = ZMTransportRequest(path: "/assets/v3/\(assetId)", method: .methodDELETE, payload: nil, apiVersion: 0)
    ...
    func testThatUploadMarkedAsFailedOnUnsuccessfulResponse() {
        ...
        let failedResponse = ZMTransportResponse(payload: nil, httpStatus: 500, transportSessionError: nil, apiVersion: 0)
    ...
    func testThatUploadIsMarkedAsDoneAfterSuccessfulResponse() {
        ...
        let successResponse = ZMTransportResponse(payload: payload as NSDictionary, httpStatus: 200, transportSessionError: nil, apiVersion: 0)
...
extension UserImageAssetUpdateStrategyTests {
    ...
    func testThatItUpdatesCorrectUserImageDataForPreviewImage() {
        ...
        let response = ZMTransportResponse(imageData: imageData, httpStatus: 200, transportSessionError: nil, headers: nil, apiVersion: 0)
