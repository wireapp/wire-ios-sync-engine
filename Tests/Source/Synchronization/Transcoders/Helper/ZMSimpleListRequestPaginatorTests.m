...
- (void)testThatItForwardsNextRequestToTheSingleRequestSync
{
    ...
    [[[self.singleRequestSync expect] andReturn:expectedRequest] nextRequestForAPIVersion:v0];
...
- (void)testThatItCallsThUUIDExtractorOnASuccessfulRequest
{
    ...
    // expect
    ZMTransportResponse *response = [ZMTransportResponse responseWithPayload:expectedPayload HTTPStatus:200 transportSessionError:nil apiVersion:v0];
...
- (void)testThatItResetsTheSingleRequestAfterEachTemporaryFailureResponse
{
    ...
    ZMTransportResponse *response = [ZMTransportResponse responseWithPayload:@{} HTTPStatus:500 transportSessionError:nil apiVersion:v0];
...
- (void)testThatItDoesNotHaveMoreToDownloadAndItDoesNotCallTheExtractorIfThereIsAPermanentError__ParsePermanentErrorResponse_False
{
    ...
    ZMTransportResponse *response = [ZMTransportResponse responseWithPayload:@{@"has_more" : @1} HTTPStatus:400 transportSessionError:nil apiVersion:v0];
...
- (void)testThatItHasMoreToDownloadAndItCallsTheExtractorIfThereIsAPermanentError_Code404_ParsePermanentErrorResponse_True
{
    ...
    ZMTransportResponse *response = [ZMTransportResponse responseWithPayload:@{@"has_more" : @1} HTTPStatus:404 transportSessionError:nil apiVersion:v0];
...
- (void)testThatItDoesHaveMoreToDownloadAndDoesNotCallTheExtractorIfThereIsATemporaryError
{
    ...
    ZMTransportResponse *response = [ZMTransportResponse responseWithPayload:nil HTTPStatus:500 transportSessionError:nil apiVersion:v0];
